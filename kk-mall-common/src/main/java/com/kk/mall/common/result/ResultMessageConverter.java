...
/**
 * 为string类型返回值定制的消息处理器，配合补充{@link ResultSuccessHandler}。
 * <p>
...
public class ResultMessageConverter extends AbstractHttpMessageConverter<Object> {
    ...
    public ResultMessageConverter(Charset charset) {
    ...
    @Autowired
    public ResultMessageConverter setMapper(ObjectMapper mapper) {
        this.mapper = mapper;
        return this;
    }
}
